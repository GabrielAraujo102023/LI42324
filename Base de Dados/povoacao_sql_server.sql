...
INSERT INTO Leilao (Estado, Comprador, Valor_base, Valor_minimo, TempoCriacao, Preco_venda, Vendedor)
	VALUES ('aberto', NULL, 300, 200, DATEADD(HOUR, -22, GETDATE()), 228, 2);
GO
...
INSERT INTO Vinil (Artista, Album, AnoLancamento, Condicao_disco, Condicao_capa, Categoria, Duracao, Tamanho, Rotacoes, Tipo, Gravadora, Edicao_especial, Remasterizado, Fotos_Vinil, Cliente, Leilao)
VALUES ('Michael Jackson', 'Thriller', '1982-01-01', 5, 5, 'Pop', 42, 12, 33, 'LP', 'Epic Records', 1, 1, 'https://static.dw.com/image/63920593_605.jpg', 2, 6);

INSERT INTO Vinil (Artista, Album, AnoLancamento, Condicao_disco, Condicao_capa, Categoria, Duracao, Tamanho, Rotacoes, Tipo, Gravadora, Edicao_especial, Remasterizado, Fotos_Vinil, Cliente, Leilao)
VALUES ('Led Zeppelin', 'IV', '1971-01-01', 1, 3, 'Rock', 42, 12, 33, 'LP', 'Atlantic Records', 1, 1, 'https://upload.wikimedia.org/wikipedia/pt/4/4b/LedZeppelinIV.jpg', 2, 6);

INSERT INTO Vinil (Artista, Album, AnoLancamento, Condicao_disco, Condicao_capa, Categoria, Duracao, Tamanho, Rotacoes, Tipo, Gravadora, Edicao_especial, Remasterizado, Fotos_Vinil, Cliente, Leilao)
VALUES ('Queen', 'A Night at the Opera', '1975-01-01', 1, 4, 'Rock', 43, 12, 33, 'LP', 'EMI', 1, 1, 'https://upload.wikimedia.org/wikipedia/pt/b/bf/A_Night_at_the_Opera_Queen.jpg', 2, 6);

INSERT INTO Vinil (Artista, Album, AnoLancamento, Condicao_disco, Condicao_capa, Categoria, Duracao, Tamanho, Rotacoes, Tipo, Gravadora, Edicao_especial, Remasterizado, Fotos_Vinil, Cliente, Leilao)
VALUES ('Bob Dylan', 'Highway 61 Revisited', '1965-01-01', 5, 3, 'Folk', 41, 12, 33, 'LP', 'Columbia Records', 1, 1, 'https://upload.wikimedia.org/wikipedia/en/9/95/Bob_Dylan_-_Highway_61_Revisited.jpg', 2, 6);

INSERT INTO Vinil (Artista, Album, AnoLancamento, Condicao_disco, Condicao_capa, Categoria, Duracao, Tamanho, Rotacoes, Tipo, Gravadora, Edicao_especial, Remasterizado, Fotos_Vinil, Cliente, Leilao)
VALUES ('The Rolling Stones', 'Sticky Fingers', '1971-01-01', 4, 2, 'Rock', 42, 12, 33, 'LP', 'Rolling Stones Records', 1, 1, 'https://upload.wikimedia.org/wikipedia/en/5/57/The_Rolling_Stones_-_Sticky_Fingers.png', 2, 3);

INSERT INTO Vinil (Artista, Album, AnoLancamento, Condicao_disco, Condicao_capa, Categoria, Duracao, Tamanho, Rotacoes, Tipo, Gravadora, Edicao_especial, Remasterizado, Fotos_Vinil, Cliente, Leilao)
VALUES ('Nirvana', 'Nevermind', '1991-01-01', 3, 3, 'Grunge', 42, 12, 33, 'LP', 'DGC Records', 1, 1, 'https://upload.wikimedia.org/wikipedia/pt/3/3f/Nevermind.jpg', 2, 4);

INSERT INTO Vinil (Artista, Album, AnoLancamento, Condicao_disco, Condicao_capa, Categoria, Duracao, Tamanho, Rotacoes, Tipo, Gravadora, Edicao_especial, Remasterizado, Fotos_Vinil, Cliente, Leilao)
VALUES ('David Bowie', 'The Rise and Fall of Ziggy Stardust', '1972-01-01', 4, 5, 'Rock', 42, 12, 33, 'LP', 'RCA Records', 1, 1, 'https://upload.wikimedia.org/wikipedia/en/0/01/ZiggyStardust.jpg', 3, 5);

INSERT INTO Vinil (Artista, Album, AnoLancamento, Condicao_disco, Condicao_capa, Categoria, Duracao, Tamanho, Rotacoes, Tipo, Gravadora, Edicao_especial, Remasterizado, Fotos_Vinil, Cliente, Leilao)
VALUES ('The Who', 'Whos Next', '1971-01-01', 5, 4, 'Rock', 42, 12, 33, 'LP', 'Track Records', 1, 1, 'https://upload.wikimedia.org/wikipedia/en/4/44/Whosnext.jpg', 5, 1);
...
INSERT INTO Vinil (Artista, Album, AnoLancamento, Condicao_disco, Condicao_capa, Categoria, Duracao, Tamanho, Rotacoes, Tipo, Gravadora, Edicao_especial, Remasterizado, Fotos_Vinil, Cliente, Leilao)
VALUES ('The Doors', 'The Doors', '1967-01-01', 3, 4, 'Rock', 44, 12, 33, 'LP', 'Elektra Records', 1, 1, 'https://upload.wikimedia.org/wikipedia/en/thumb/9/98/TheDoorsTheDoorsalbumcover.jpg/220px-TheDoorsTheDoorsalbumcover.jpg', 7, 2);
...
INSERT INTO Vinil (Artista, Album, AnoLancamento, Condicao_disco, Condicao_capa, Categoria, Duracao, Tamanho, Rotacoes, Tipo, Gravadora, Edicao_especial, Remasterizado, Fotos_Vinil, Cliente, Leilao)
VALUES ('Jimi Hendrix', 'Are You Experienced', '1967-01-01', 3, 4, 'Rock', 38, 12, 33, 'LP', 'Track Records', 1, 1, 'https://upload.wikimedia.org/wikipedia/commons/3/33/Are_You_Experienced_-_US_cover-edit.jpg', 3, 5);

INSERT INTO Vinil (Artista, Album, AnoLancamento, Condicao_disco, Condicao_capa, Categoria, Duracao, Tamanho, Rotacoes, Tipo, Gravadora, Edicao_especial, Remasterizado, Fotos_Vinil, Cliente, Leilao)
VALUES ('Metallica', 'Master of Puppets', '1986-01-01', 1, 2, 'Metal', 54, 12, 33, 'LP', 'Elektra Records', 1, 1, 'https://midias.correiobraziliense.com.br/_midias/png/2022/07/13/1000x1000/1_metallica-26046466.png?20220713152408?20220713152408', 5, 1);

INSERT INTO Vinil (Artista, Album, AnoLancamento, Condicao_disco, Condicao_capa, Categoria, Duracao, Tamanho, Rotacoes, Tipo, Gravadora, Edicao_especial, Remasterizado, Fotos_Vinil, Cliente, Leilao)
VALUES ('Prince', 'Purple Rain', '1984-01-01', 2, 3, 'Pop', 43, 12, 33, 'LP', 'Warner Bros. Records', 1, 1, 'https://upload.wikimedia.org/wikipedia/en/9/9c/Princepurplerain.jpg', 7, 2);
...
INSERT INTO Vinil (Artista, Album, AnoLancamento, Condicao_disco, Condicao_capa, Categoria, Duracao, Tamanho, Rotacoes, Tipo, Gravadora, Edicao_especial, Remasterizado, Fotos_Vinil, Cliente, Leilao)
VALUES ('Radiohead', 'OK Computer', '1997-01-01', 2, 5, 'Alternative', 53, 12, 33, 'LP', 'Parlophone', 1, 1, 'https://static.fnac-static.com/multimedia/Images/PT/NR/4e/a0/02/172110/1540-6/tsp20160815151428/Ok-Computer.jpg', 3, 5);

INSERT INTO Vinil (Artista, Album, AnoLancamento, Condicao_disco, Condicao_capa, Categoria, Duracao, Tamanho, Rotacoes, Tipo, Gravadora, Edicao_especial, Remasterizado, Fotos_Vinil, Cliente, Leilao)
VALUES ('Bob Marley', 'Legend', '1984-01-01', 1, 2, 'Reggae', 54, 12, 33, 'LP', 'Island Records', 1, 1, 'https://upload.wikimedia.org/wikipedia/pt/c/cc/Legend_Bob_Marley.jpg', 5, 1);

INSERT INTO Vinil (Artista, Album, AnoLancamento, Condicao_disco, Condicao_capa, Categoria, Duracao, Tamanho, Rotacoes, Tipo, Gravadora, Edicao_especial, Remasterizado, Fotos_Vinil, Cliente, Leilao)
VALUES ('Elton John', 'Goodbye Yellow Brick Road', '1973-01-01', 3, 3, 'Rock', 47, 12, 33, 'LP', 'MCA Records', 1, 1, 'https://upload.wikimedia.org/wikipedia/pt/9/94/Elton_John_-_1973_-_Goodbye_Yellow_Brick_Road.jpg', 7, 2);
...
INSERT INTO Vinil (Artista, Album, AnoLancamento, Condicao_disco, Condicao_capa, Categoria, Duracao, Tamanho, Rotacoes, Tipo, Gravadora, Edicao_especial, Remasterizado, Fotos_Vinil, Cliente, Leilao)
VALUES ('Radiohead', 'Kid A', '2000-01-01', 1, 1, 'Alternative', 49, 12, 33, 'LP', 'Parlophone', 1, 1, 'https://upload.wikimedia.org/wikipedia/pt/4/44/KidA.jpg', 3, 5);

INSERT INTO Vinil (Artista, Album, AnoLancamento, Condicao_disco, Condicao_capa, Categoria, Duracao, Tamanho, Rotacoes, Tipo, Gravadora, Edicao_especial, Remasterizado, Fotos_Vinil, Cliente, Leilao)
VALUES ('Nirvana', 'In Utero', '1993-01-01', 2, 4, 'Grunge', 41, 12, 33, 'LP', 'DGC Records', 1, 1, 'https://upload.wikimedia.org/wikipedia/pt/b/b4/InUtero.jpeg', 7, 2);

INSERT INTO Vinil (Artista, Album, AnoLancamento, Condicao_disco, Condicao_capa, Categoria, Duracao, Tamanho, Rotacoes, Tipo, Gravadora, Edicao_especial, Remasterizado, Fotos_Vinil, Cliente, Leilao)
VALUES ('The Rolling Stones', 'Let It Bleed', '1969-01-01', 3, 3, 'Rock', 42, 12, 33, 'LP', 'Decca Records', 1, 1, 'https://m.media-amazon.com/images/I/81Ut0SKKVhL._UF1000,1000_QL80_.jpg', 7, 2);
